class World5 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(400, 300, 'mapbasejungle').setOrigin(0.5, 0.5).setDisplaySize(800, 600);

        const mapLabel = this.add.image(400, 300, 'maplablejungle').setOrigin(0.5, 0.5).setAlpha(0);
        ...
        const hotspots = [
            ...
            {
                x: 200, y: 330, width: 80, height: 80,
                level: "l14",
                text2: "Level 2: Villiage of the Beastmen"
            },
            {
                x: 440, y: 550, width: 80, height: 80,
                level: "l15",
    ...
    hotspots.forEach(hotspot => {
        this.add.rectangle(hotspot.x, hotspot.y, hotspot.width, hotspot.height, 0x000000, 0)
            ...
            .on('pointerdown', () => {
                arrow.setVisible(false);
                this.sound.play('ui');
                this.scene.get('OSTManager').crossfadeTo('world5', 300);
                goToLevel("World 5: Jungle of the Beastmen", hotspot.text2, "SELECTED!", hotspot.level);
            });
    });
